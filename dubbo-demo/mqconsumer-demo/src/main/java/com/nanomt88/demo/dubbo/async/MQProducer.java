...
public class MQProducer {
    ...
    public void init() throws MQClientException {
        ...
        String groupName = env.getProperty("rocketmq.async.producerGroup");
        String addr = env.getProperty("rocketmq.async.namesrvAddr");
        String instanceName = env.getProperty("rocketmq.async.instanceName");

...
public class NotifyConsumer {
    ...
    public void init() throws MQClientException {
        ...
        String groupName = env.getProperty("rocketmq.asyncToSync.consumer.consumerGroup");
        String addr = env.getProperty("rocketmq.asyncToSync.consumer.namesrvAddr");
        String instanceName = env.getProperty("rocketmq.asyncToSync.consumer.instanceName");
        String topic = env.getProperty("rocketmq.asyncToSync.consumer.topic");
        String expression = env.getProperty("rocketmq.asyncToSync.consumer.topic.expression");

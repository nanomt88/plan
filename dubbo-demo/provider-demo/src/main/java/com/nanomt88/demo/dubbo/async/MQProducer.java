...
public class MQProducer {
    ...
    public void init() throws MQClientException {
        ...
        String groupName = env.getProperty("rocketmq.asyncToSync.producer.producerGroup");
        String addr = env.getProperty("rocketmq.asyncToSync.producer.namesrvAddr");
        String instanceName = env.getProperty("rocketmq.asyncToSync.producer.instanceName");
